    ...
    def from_paths(
        ...
        if knowledge:
            for item in knowledge:
                ...
                knowledge_match_lookup[item.get("intention_id")] = item.get("other_config", {}).get("match_num", 1000)
    ...
    def from_files(
        ...
        if knowledge:
            for item in knowledge:
                ...
                knowledge_match_lookup[item.get("intention_id")] = match_num if isinstance(match_num, int) else 10000
